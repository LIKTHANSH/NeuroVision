...
7. The Arduino toggles the corresponding **LED / appliance output** on its digital pins.
...
| 5V DC Fan | Optional appliance demo |
| BC547 Transistor | Fan motor driver |
| 1N4007 Diode | Flyback protection for fan |
| 1kΩ Resistor | Base resistor for BC547 |
